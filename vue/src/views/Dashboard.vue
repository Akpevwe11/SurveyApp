...
<PageComponent title="Dashboard">
  ...
  >
   ...
   <div
    class="row-span-2 animate-fade-in-down order-3 text-center bg-white shadow-md p-4 lg:order-1"
   >
  ...
  <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd" />
    ...
    <div
    class="bg-white animate-fade-in-down shadow-md p-3 row-span-2 ordrer-4 lg:order-3"
    style="animation-delay: 0.3s"
   >
     <div class="flex justify-between items-center mb-3 px-2">
      <h3 class="text-2xl text-center font-semibold">Latest Answers</h3>
