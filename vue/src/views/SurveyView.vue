...
<PageComponent>
    ...
    <form v-else @submit.prevent="saveSurvey" class="animate-fade-in-down">
      <div class="shadow sm:rounded-md sm:overflow-hidden">
          <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <div class="flex items-start">
                  ...
                  <div class="ml-3 text-sm">
                    <lable for="status" class="font-medium text-gray-700">Active</lable>
                  </div>
                </div>
                <!---/Status-->
         </div>
         ...
         <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                 <h3 class="text-2x1 font-semibold flex items-center justify-between">Questions
                  <button
                    type="button"
                    @click="addQuestion()"
                    class="
                  ...
                  You don't have any questons created
                  </div>
...
//watch the current survey data change and when this happens we update local..
watch(
